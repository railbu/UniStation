  ...
  <div id="page" class="page">
    <div class="col-xs-12 col-sm-6">
      <div class="address_delivery select form-group selector1"> 
        <label for="id_address_delivery">CHOOSE ADDRESS</label> 
        <select class="form-control address_select" name="id_address_delivery" id="id_address_delivery">
          <option value="64" selected="selected"> MY ADDRESS</option> 
        </select>
        <span class="waitimage"></span>
      </div>
      <br />
      <div class="fr" style="background-color:#ff666b;width:100px;height:40px;border-radius:2px;text-align:center;"> 
            <a href="javascript:;" class="topay topay_ok" id="topay"  style="font-size: 24px;color:white;">NEXT</a> 
          </div> 
        </div>
        <br />
    </div>
