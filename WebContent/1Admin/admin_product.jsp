	...
	<div class="container">	 			
		...
		<div class="header_bottom_right" style="margin-top:60px;">			
	        <div class="h_menu4"><!-- start h_menu4 -->
				<ul class="nav">
					<li><a href="${ctx}/1Admin/admin_list.action">User Information</a></li>
					<li class="active" style="background: #ff666b;color:#fff"><a href="${ctx}/1Admin/admin_plist.action">Products Information</a></li>
				</ul>
	      </div><!-- end h_menu4 -->		   
      </div>
    </div>
...
<!--Slide was here-->
<div class="column_center" style="height:55px;">
  <div class="container">
	<div class="search">
	  <div class="stay">Products Information Management</div>
	</div>
	<ul class="social">
	  <li><div class="search" style="margin-right:200px;"><a href="home.jsp"><input type="submit" value=""></a></div></li>
	  <div class="clearfix"> </div>
	</ul>
	<div class="clearfix"> </div>
  </div>
    ...
    <div class="cart_list"> 
      <div class="cart_th"> 
        <ul class="cle"> 
          ...
          <li class="td td_item">商品名</li> 
          <li class="td td_info">商品描述</li> 
          <li class="td td_price">价格</li> 
          <li class="td td_num">上架日期</li>
          <li class="td td_sum">关键字</li> 
      ...
      <div id="shop_list">  
        <div class="shop_line"> 
          <div class="shop_items">  
            ...
            <s:iterator value="plist" var="item">
                  ...
                  <div class="td_inner"> 
                    ...
                    <div class="item_info"> 
                      <div class="item_title" style="margin-top:25px;float:left;margin-left:20px;"> 
                        <a href="" target="_blank"><s:property value="name" /></a> 
                      </div> 
                    </div> 
                  </div> 
                </li> 
                <li style="width:160px;right:760px;float:right;z-index:2;position:absolute;text-align:center;"> 
                  <div style="margin-top:42px;right:50px;"> <a  class="item_del" data-cid="561e7b6de4b0ad3603d7cd1a"><s:property value="description" /></a>  </div> 
                </li> 
                <li style="width:120px;right:585px;float:right;z-index:2;position:absolute;text-align:center;"> 
                  <div style="margin-top:42px;right:50px;"> <a class="item_del" data-cid="561e7b6de4b0ad3603d7cd1a"><s:property value="price" /></a>  </div> 
                </li> 
                <li style="width:80px;right:470px;float:right;z-index:2;position:absolute;text-align:center;"> 
                  <div style="margin-top:42px;right:50px;"> <a class="item_del" data-cid="561e7b6de4b0ad3603d7cd1a"><s:property value="time" /></a>  </div> 
                </li> 
                <li style="width:80px;right:360px;float:right;z-index:2;position:absolute;text-align:center;"> 
                  <div style="margin-top:42px;right:50px;"> <a  class="item_del" data-cid="561e7b6de4b0ad3603d7cd1a"><s:property value="keyword" /></a>  </div> 
                </li> 
                <li class="td td_op"> 
                  <div class="td_inner"> 
						<s:url value="/1Admin/admin_deleteproduct" id="delete_product">
							<s:param name="id" value="id" />
						</s:url>
						
						<s:a href="%{delete_product}" cssClass="btn btn-danger" style="height:32px">删除</s:a>
				  </div> 
                </li> 
              </ul> 
              </s:iterator>
