    ...
    <nav id="header_outer" class="navbar navbar-inverse navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-header-collapse">
            ...
            <ul class="nav navbar-nav navbar-right ng-scope" ng-controller="user_ctrl" id="header_me">
                ...
                <li>
                    <a class="mr_15" href="login.jsp">登陆</a>
                </li>
	 ...
	 <div class="header_bottom-box">
		<div class="header_bottom_left">
			<div class="logo" style="margin-top:-30px">
				<a><img src="${ctx}/resources/index/logo.png" height="130" alt=""/></a>
			</div>
			<ul class="clock" style="margin-top:20px">
				<i class="clock_icon"> </i>
				<li class="clock_desc">Justo 24/h</li>
			</ul>
		</div>
		<div class="header_bottom_right" style="margin-top:8px">
			<div class="search">
			  <input style="height:47px" type="text" value="Search Product" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search Product';}">
